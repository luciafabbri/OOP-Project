...
public class DoorCheck {
	...
	public boolean doorWest(final Pair<Integer, Integer> pos) {
		 return ((pos.getX() < GameSettings.TILESIZE) && pos.getX() > 0) && (pos.getY() + 48 > (GameSettings.TILESIZE * 5) && pos.getY() + 48 < (GameSettings.TILESIZE * 5 + 44));
	}
	...
	public boolean doorEast(final Pair<Integer, Integer> pos) {
		 return ((pos.getX() > GameSettings.WIDTH - GameSettings.TILESIZE * 2 && pos.getX() < GameSettings.WIDTH) && (pos.getY() + 48 > (GameSettings.TILESIZE * 5) && pos.getY() + 48 < (GameSettings.TILESIZE * 5 + 44)));
	}
