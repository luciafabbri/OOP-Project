...
public class DoorCheck {
	...
	public boolean transNorth(final Pair<Integer, Integer> pos) {
		 return (pos.getX() > (GameSettings.TILESIZE * 9) - 11 && pos.getX() < (GameSettings.TILESIZE * 9 ) + 11) && (pos.getY() < -5);
	}
	...
	public boolean doorEast(final Pair<Integer, Integer> pos) {
		 return (pos.getX() > GameSettings.WIDTH - GameSettings.TILESIZE * 3  && (pos.getY() + 48 > (GameSettings.TILESIZE * 5) && pos.getY() + 48 < (GameSettings.TILESIZE * 5 + 44)));
	}
	...
	public boolean doorSouth(final Pair<Integer, Integer> pos) {
		return (pos.getX() > (GameSettings.TILESIZE * 9) - 11 && pos.getX() < (GameSettings.TILESIZE * 9 ) + 11) && (pos.getY() > GameSettings.HEIGHT - GameSettings.TILESIZE * 3);
	}
