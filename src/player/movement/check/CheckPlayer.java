...
public interface CheckPlayer extends CheckPos{
	 ...
	 * @param the coordinates of the player and a map 
	 */
	 ...
	 * @param the room in which the player is and his coordinates
	 ...
	 * @param the room in which the player is and his coordinates
	 */
	public boolean checkEnemyRoom(RoomDesign currentRoom, Pair<Integer, Integer> pos);	
